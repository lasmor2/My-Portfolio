        ...
        <div className="lg:col-span-7 flex flex-col gap-8 order-2 lg:order-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4">
            {aboutData.stats.map((stat) => (
              <div
                key={stat.label}
                className="p-4 rounded-2xl bg-secondary/50 border border-border backdrop-blur-sm text-center lg:text-left"
              >
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-2">
            {aboutData.interests.map((interest) => (
              <div
                key={interest}
                className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary/50 border border-border text-xs font-medium text-muted-foreground"
              >

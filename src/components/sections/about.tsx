      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-5 flex justify-center order-1 lg:order-1">
          <div className="relative group">
            {/* Outer Glow Ring */}
            <div className="absolute -inset-1 rounded-[2.5rem] bg-linear-to-tr from-white/20 via-white/5 to-transparent blur-sm opacity-50 group-hover:opacity-100 transition-opacity duration-500" />

            {/* Main Image Card */}
            <div className="relative w-70 md:w-90 h-80 md:h-120 rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-black">
              {" "}
              <Image
                src={aboutData.image}
                alt="Profile picture"
